...
export function ShareModal({
  ...
  const shareLinks = [
    ...
    },
    {
      ...
      href: `https://pinterest.com/pin/create/button/?url=${encodeURIComponent(profileUrl)}&description=${encodeURIComponent(shareText)}`,
      color: "bg-[#E60023] hover:bg-[#AD081B]",
    },
    {
      name: "Email",
      icon: <Mail className="h-5 w-5" />,
      href: `mailto:?subject=${encodeURIComponent(`${displayName || username}'s Recipe Collection`)}&body=${encodeURIComponent(`${shareText}\n\n${profileUrl}`)}`,
      color: "bg-gray-600 hover:bg-gray-700",
    },
    {
      name: "SMS",
      icon: <MessageCircle className="h-5 w-5" />,
      href: `sms:?body=${encodeURIComponent(`${shareText} ${profileUrl}`)}`,
