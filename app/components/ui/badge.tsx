...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-sm border border-border px-3 py-1 text-[10px] font-mono uppercase tracking-[0.1em] font-bold w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1.5 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-700 overflow-hidden",
  {
    variants: {
      variant: {
        default:
