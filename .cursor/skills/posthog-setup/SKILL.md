---
name: posthog-setup
description: Set up PostHog analytics and feature flags in Cloudflare Workers + React Router projects. Use when adding analytics, implementing feature flags, tracking events, or when the user mentions PostHog, analytics, or A/B testing.
---
...
- PostHog MCP server is configured for AI-assisted analytics queries
